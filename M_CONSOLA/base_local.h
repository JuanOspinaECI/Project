...
public:
    ...
    bool CerrarDB();
    /*!
     * \brief GuardarDatoProm metodo para guardar datos promedios en la tabla de promedios
    ...
    /*!
     * \brief GuardarDatoMax metodo para guardar los datos mas grandes tomados en la tabla de maximos
     * \param a es el parametro que contiene todos los promedios de los diferentes sensores
    ...
    /*!
     * \brief GuardarDatoMin metodo para guardar los datos menores en la tabla de minimos
    ...
    /*!
     * \brief GuardarHist metodo que guarda el historial de la persona que entro a utilizar el dispositivo
