...
public:
    ...
    /*!
     * \brief maximo metodo que calcula el maximo valor entre Sensores de a y Sensores de b
    ...
    /*!
     * \brief minimo metodo que calcula el minimo valor entre Sensores de a y Sensores de b
     * \param a primero sensor a comparar
     * \param b segundo sensor a comparar
    ...
    /*!
     * \brief actualizar metodo que simula que los sensores adquieren nuevos valores tomados
     */
    ...
    /*!
     * \brief reset metodo que deja todos los sensores en valor 0.0
     */
    void reset();
};
